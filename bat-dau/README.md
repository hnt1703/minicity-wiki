...
### 1. Tạo Nhân Vật
Bạn sẽ bắt đầu bằng việc tạo ngoại hình cho nhân vật. Có thể tùy chỉnh khuôn mặt, kiểu tóc, và đặt tên. Xem chi tiết trong [Tạo Nhân Vật](tao-nhan-vat.md).

### 2. Khám Phá Thành Phố
Sau khi tạo xong, nhân vật sẽ xuất hiện trước tòa nhà. Hãy đi bộ xung quanh để làm quen:
- **Cửa hàng quần áo** — Đổi trang phục (icon áo sơ mi trên bản đồ)
- **Ngân hàng** — Quản lý tài khoản
- **Quán ăn** — Mua đồ ăn uống
- **ATM** — Rút tiền
...
- **Đừng quên ăn uống** — Thanh đói và khát sẽ ảnh hưởng đến sức khỏe
- **Ghi nhớ phím tắt** — Sử dụng `F1` thường xuyên để truy cập menu
- **Tham gia cộng đồng** — Kết bạn để có người hướng dẫn
- **Bảo vệ tài sản** — Gửi tiền vào ngân hàng, cất xe trong garage
- **Đọc kỹ hướng dẫn** — Mỗi nghề đều có cách chơi riêng
...
> Tiếp theo: [Tạo Nhân Vật](tao-nhan-vat.md) →
